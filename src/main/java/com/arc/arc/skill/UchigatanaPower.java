...
public class UchigatanaPower extends ComboBasicAttack {
    ...
    public List<Component> getTooltipOnItem(ItemStack itemstack, CapabilityItem cap, PlayerPatch<?> playerCap) {
        ...
        list.add(new TextComponent("普攻一段以及跳跃冲刺攻击会开启攻击计数(从一层开始)：§b攻击计数大于五层时(命中四次)，§6可按").withStyle(ChatFormatting.YELLOW).append(EpicFightKeyMappings.WEAPON_INNATE_SKILL.getTranslatedKeyMessage()).append(new TextComponent("§6§l使用技能-十字居合斩，使用后层数清空，若命中则提升至九层；§b当攻击计数达到十层(命中九次)时，§6§l可使用居合架势")));
