...
public class ArcbladeMini extends ComboBasicAttack {
    ...
    public List<Component> getTooltipOnItem(ItemStack itemstack, CapabilityItem cap, PlayerPatch<?> playerCap) {
        ...
        list.add(new TextComponent("普攻一段以及跳跃冲刺攻击会开启攻击命中计数(从一层开始)：§b攻击计数大于五层时(命中四次)，§6会强化第三段普攻，§b当攻击计数达到十层(命中九次),§6会强化第四段普攻;§b常态可按").withStyle(ChatFormatting.YELLOW).append(EpicFightKeyMappings.WEAPON_INNATE_SKILL.getTranslatedKeyMessage()).append(new TextComponent("§6§l使用技能-‘升星斩’，使用后命中则提升至九层")));
