...
public class TachiSkill extends ComboBasicAttack{
    ...
    public List<Component> getTooltipOnItem(ItemStack itemstack, CapabilityItem cap, PlayerPatch<?> playerCap) {
        ...
        list.add(new TranslatableComponent("§b常态技能命中进入60s强化状态:§c§l强化普攻三段(霸体但受伤增加)§6且解锁三段普攻后的技能派生;"));
        ...
        list.add(new TranslatableComponent("1A后按").append(new TextComponent(("§c后退S")).append(new TextComponent(("消耗一层技能上挑斩击，若命中后续可§b消耗两层技能§c§l发动招架反击,§6若命中则标记敌人40S")))));
        list.add(new TranslatableComponent("2A后按").append(new TextComponent(("§c后退S")).append(new TextComponent(("消耗两层技能主动后翻滚GP,若完美闪避则§c§l发动突进,§6若命中则标记敌人40S")))));
