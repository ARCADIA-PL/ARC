...
public class TachiSkill_Lv0 extends ComboBasicAttack{
    public TachiSkill_Lv0(Builder builder) {
        super(builder);
    }
    @Override
    public List<Component> getTooltipOnItem(ItemStack itemstack, CapabilityItem cap, PlayerPatch<?> playerCap) {
        ...
        list.add(new TranslatableComponent("1A后按").append(new TextComponent(("§c后退S")).append(new TextComponent(("消耗一层技能上挑斩击，若命中后续可§b消耗两层技能§c§l发动招架反击,§6若命中则标记敌人20S")))));
