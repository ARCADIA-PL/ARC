...
public class TransformedArcbladeHandlers {
    ...
    public static void onPlayerTick(PlayerTickEvent event) {
        ...
        // 仅在服务端处理且手持 TransformedArcbladeItem 时生效
        if (!player.level.isClientSide && mainHandItem.getItem() instanceof TransformedArcbladeItem) {
