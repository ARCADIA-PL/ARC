...
public class Skills {
    ...
    public static void registerSkills() {
        ...
        ComboNode ArcAuto1 = ComboNode.createNode(()-> StarAnimations.TACHI_TWOHAND_AUTO_1)
                .addHitEvent(BiEvent.createBiCommandEvent("effect give @s irons_spellbooks:rend 2 4",true))
        ...
        ComboNode ArcAuto3 = ComboNode.createNode(()-> StarAnimations.YAMATO_AUTO4)
                ...
                .addHitEvent(BiEvent.createBiCommandEvent("effect give @s irons_spellbooks:rend 5 12",true))
                .setPlaySpeed(1.4F)
        ...
        ComboNode ArcAuto4 = ComboNode.createNode(()-> WOMAnimations.KATANA_AUTO_2)
                .addHitEvent(BiEvent.createBiCommandEvent("effect give @s irons_spellbooks:rend 1 6",true))
        ...
        ComboNode ArcdashSkill = ComboNode.createNode(()-> StarAnimations.YAMATO_STRIKE1)
                ...
                .addHitEvent(BiEvent.createBiCommandEvent("effect give @s irons_spellbooks:rend 3 8",true))
                .setDamageMultiplier(ValueModifier.multiplier(0.6F))
                .setPriority(6);
        ...
        ComboNode ArcGP1extendS1=ComboNode.createNode(()->StarAnimations.YAMATO_STRIKE2)
                ...
                .addHitEvent(BiEvent.createBiCommandEvent("effect give @s irons_spellbooks:rend 4 5",true))
        ...
        ComboNode ArcGP3Skill4 =ComboNode.createNode(()->WOMAnimations.AGONY_PLUNGE_FORWARD)
                ...
                .setNotCharge(true)
                .addHitEvent(BiEvent.createBiCommandEvent("indestructible @s play \"epicfight:biped/combat/hit_long\" 4 0.5",true))
                ;
        ...
        ArcGP3Attack10.key1(ArcAutoDash5);
        ArcGP3Attack11.key1(ArcAutoDash5);
        ArcGP3Attack12.key1(ArcAutoDash5);
        ArcGP3Attack13.key1(ArcAutoDash5);
