...
public class Skills {
    ...
    public static void registerSkills() {
        ...
        ComboNode Arc3AS1=ComboNode.createNode(()->StarAnimations.YAMATO_COUNTER1)
                ...
                .addTimeEvent(TimeStampedEvent.createTimeCommandEvent(0.69F, "effect give @s irons_spellbooks:abyssal_shroud 1 0", false))
                .addTimeEvent(new TimeStampedEvent(0.7F, (entityPatch)-> {entityPatch.playAnimationSynchronized(StarAnimations.YAMATO_COUNTER2,0F);}))
                .addCondition(new StackCondition(1,8))
