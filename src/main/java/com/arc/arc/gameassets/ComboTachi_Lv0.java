...
import com.arc.arc.skill.TachiSkill_Lv0;
...
public class ComboTachi_Lv0 {
    public static Skill ComboTachi_Lv0;
    public static void registerSkills(){
        ...
        ComboNode Skill_LethalSlicing_Once_Combo = ComboNode.createNode(() -> StarAnimations.LETHAL_SLICING_ONCE)
                ...
                .setNotCharge(true).setConvertTime(0.2F).setStunTypeModifier(StunType.LONG).setPlaySpeed(0.2F).setNewPhase(1).setArmorNegation(50).setDamageMultiplier(ValueModifier.multiplier(2F)).setImpactMultiplier(2F).setStunTypeModifier(StunType.HOLD)
                .addHitEvent(new BiEvent((entityPatch, entity) -> {
                    entityPatch.getOriginal().removeEffect(new MobEffectInstance(ArcEffectsRegistry.TACHI_ENHANCED_PHASE.get()).getEffect());
                }))
                .addHitEvent(new BiEvent(((entityPatch, entity) -> {
        ...
        ComboNode Skill_LethalSlicing_Twice_Combo = ComboNode.createNode(() -> Animations.RUSHING_TEMPO2)
                .setNotCharge(true).setConvertTime(-0.05F).setNewPhase(1).setArmorNegation(50).setDamageMultiplier(ValueModifier.multiplier(2F))
                .addHitEvent(new BiEvent((entityPatch, entity) -> {
                    entityPatch.getOriginal().removeEffect(new MobEffectInstance(ArcEffectsRegistry.TACHI_ENHANCED_PHASE.get()).getEffect());
                }))
                .addHitEvent(new BiEvent(((entityPatch, entity) -> {
        ...
        ComboNode Final_Skill_CrossSlash_Once = ComboNode.createNode(()->StarAnimations.YAMATO_STRIKE1)
                ...
                .setNotCharge(true).setStunTypeModifier(StunType.LONG).setArmorNegation(50).setDamageMultiplier(ValueModifier.multiplier(1.2F)).setPriority(4).setConvertTime(-0.1F).setStunTypeModifier(StunType.LONG).setCanBeInterrupt(false)
        ...
        ComboNode Final_Skill_CrossSlash_Twice = ComboNode.createNode(()->StarAnimations.FATAL_DRAW)
                .setNotCharge(true).setStunTypeModifier(StunType.LONG).setConvertTime(-0.4F).setArmorNegation(50).setDamageMultiplier(ValueModifier.multiplier(1.2F)).setStunTypeModifier(StunType.LONG).setCanBeInterrupt(false)
                .addHitEvent(new BiEvent((entityPatch, entity) -> {
                    entityPatch.playSound(EpicFightSounds.BLADE_RUSH_FINISHER,  0,0);
                }))
                .addHitEvent(new BiEvent((entityPatch, entity) -> {
        ...
        ComboNode Final_Skill_CrossSlash_Thrid = ComboNode.createNode(()->Animations.RUSHING_TEMPO2)
                .setNotCharge(true).setStunTypeModifier(StunType.LONG).setArmorNegation(50).setDamageMultiplier(ValueModifier.multiplier(1.2F)).setImpactMultiplier(2F).setConvertTime(0.2F).setCanBeInterrupt(false)
                .addHitEvent(new BiEvent((entityPatch, entity) -> {
                    LivingEntityPatch<?> targetPatch = EpicFightCapabilities.getEntityPatch(entityPatch.getTarget(), LivingEntityPatch.class);
                    if(targetPatch != null){
                        targetPatch.getOriginal().addEffect(new MobEffectInstance(ArcEffectsRegistry.Success.get(), 400));}
        ...
        ComboNode Final_Skill_Execute = ComboNode.createNode(()-> StarAnimations.TACHI_EXECUTE)
                ...
                .setPriority(10).setNotCharge(true).setArmorNegation(100).setDamageMultiplier(ValueModifier.multiplier(0.7F)).setNewPhase(1)
                .addHitEvent(new BiEvent((entityPatch, entity) -> {
                    LivingEntityPatch<?> targetPatch = EpicFightCapabilities.getEntityPatch(entityPatch.getTarget(), LivingEntityPatch.class);
                    if(targetPatch != null){
        ...
        SkillManager.register(TachiSkill_Lv0::new, TachiSkill_Lv0.createComboBasicAttack().setCombo(Tachiroot).setShouldDrawGui(true), ArcMod.MOD_ID, "combo2_lv0");
    }
    @SubscribeEvent
    public static void BuildSkills(SkillBuildEvent event) {
        ComboTachi_Lv0 = event.build(ArcMod.MOD_ID, "combo2_lv0");
    }
}
