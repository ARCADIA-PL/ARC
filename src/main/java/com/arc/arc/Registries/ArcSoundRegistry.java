...
public class ArcSoundRegistry {
    ...
    public static final RegistryObject<SoundEvent> Gesshoku =
            registerSound("gesshoku");
    public static final RegistryObject<SoundEvent> Timer =
            registerSound("timer");
    public static final RegistryObject<SoundEvent> LastStarDust =
            registerSound("laststardust");
    private static RegistryObject<SoundEvent> registerSound(String name) {
        return SOUNDS.register(name, () -> new SoundEvent(new ResourceLocation("arc", name))
        );
    }
}